...
const FormBuilder = () => {
  ...
  // ... (autres fonctions existantes inchangées jusqu'à FormField)
  ...
  const FormField = ({ field, index }) => {
    ...
    if (previewMode) {
      ...
      // ... (reste du code preview mode existant)
      return (
        <div className="mb-4">
          <label className="block text-sm font-medium mb-2">
            {field.label}
    ...
    return (
      <Card className="mb-4">
        <CardContent className="pt-6">
          ...
          {/* ... (reste du code des autres types de champs) ... */}
  ...
  // ... (reste du code du composant principal inchangé)
